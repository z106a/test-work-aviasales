...
export  default (props) => {
  return (
    <Div classTo="flex flex-column">
      <div className="text-default-font text-bold text-size16 text-lineH-28 text-color-red">Clicks<span
        className="badge bg-red text-default-font text-size12 text-lineH-14 text-colorWhite">{props.percent}</span></div>
      <div>
