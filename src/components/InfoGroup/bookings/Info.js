...
export  default (props) => {
  return (
    <Div classTo="flex flex-column">
      <div className="text-default-font text-bold text-size16 text-lineH-28 text-color4">Bookings<span
        className="badge bg-green text-default-font text-size12 text-lineH-14 text-colorWhite">{props.percent}</span></div>
      <div>
